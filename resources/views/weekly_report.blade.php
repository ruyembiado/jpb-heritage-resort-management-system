                ...
                <div class="table-responsive report-table">
                    <table class="table table-bordered" width="100%" cellspacing="0">
                        <thead>
                            ...
                            <tr>
                                <th class="text-center align-middle bg-green-secondary text-light">ENTRANCE FEE</th>
                                <th class="text-center align-middle bg-green-secondary text-light">COTTAGE FEE</th>
                                <th class="text-center align-middle bg-green-secondary text-light">FUNCTION HALL</th>
                                <th class="text-center align-middle bg-green-secondary text-light">ROOM ACCOMMODATION</th>
                                <th class="text-center align-middle bg-green-secondary text-light">FOODS</th>
                                <th class="text-center align-middle bg-green-secondary text-light">DRINKS</th>
                            </tr>
                        </thead>
                        <tbody>
                            @if ($report->isEmpty())
