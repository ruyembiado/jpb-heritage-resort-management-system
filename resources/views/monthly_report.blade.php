            ...
            <div id="print-section">
                ...
                <div class="table-responsive report-table">
                    <table class="table table-bordered" width="100%" cellspacing="0">
                        <thead class="">
                            <tr>
                                <th class="text-center align-middle bg-theme-primary text-light" rowspan="2">WEEK</th>
                        ...
                        <tbody>
                            ...
                            @else
                                ...
                                <tr class="">
                                    ...
                                    <td class="fw-bold text-center">{{ $weeklyBreakdown->sum('visitors') }}</td>
                                    <td class="fw-bold text-center">
                                        ₱{{ number_format($weeklyBreakdown->sum('entrance_fee'), 2) }}</td>
                                    <td class="fw-bold text-center">₱{{ number_format($weeklyBreakdown->sum('rental'), 2) }}
                                    </td>
                                    <td class="fw-bold text-center">
                                        ₱{{ number_format($weeklyBreakdown->sum('functionHall'), 2) }}</td>
                                    <td class="fw-bold text-center">
                                        ₱{{ number_format($weeklyBreakdown->sum('accommodation'), 2) }}</td>
                                    <td class="fw-bold text-center">₱{{ number_format($weeklyBreakdown->sum('meal'), 2) }}</td>
                                    <td class="fw-bold text-center">₱{{ number_format($weeklyBreakdown->sum('beverage'), 2) }}
                                    </td>
                                    <td class="fw-bold text-center">₱{{ number_format($weeklyBreakdown->sum('total'), 2) }}</td>
                                </tr>
                            @endif
                        </tbody>
                    </table>
